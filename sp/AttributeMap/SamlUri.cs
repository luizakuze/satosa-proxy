...
{
    public static class SamlUriMap
    {
        public const string Identifier = "urn:oasis:names:tc:SAML:2.0:attrname-format:uri";
        ...
        public static readonly Dictionary<string, string> To = From.ToDictionary(kv => kv.Value, kv => kv.Key);
    }
}
